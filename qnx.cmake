...
#add_definitions(-DWANT_CLASS_INSTANTIATION_OF_MAP)
...
SET(COMP_PATHS "-L${QNX_TARGET}/lib -L${QNX_TARGET}/usr/lib -I${QNX_TARGET}/usr/include")
SET(CMAKE_C_FLAGS "-Vgcc_nto${COMPL} -fpic ${COMP_PATHS} ")
SET(CMAKE_CXX_FLAGS "-Vgcc_nto${COMPL}_cpp -fpic -lang-c++ ${COMP_PATHS} ")
...
SET(ZLIB_ROOT ${QNX_TARGET}/${CPU}/usr/lib ${QNX_TARGET}/usr)
